...
export default function OrderDrawer({ open, onClose, orderItems, orderTotal, onIncrease, onDecrease, onSendWA }) {
  const total = orderTotal + DELIVERY_FEE
        ...
        <div className={styles.body}>
          {orderItems.length === 0 ? (
            <div className={styles.empty}>
              ...
              <p>No items added yet. Browse the catalogue and add what you need.</p>
            </div>
          ) : (
            <>
                  ...
                  <div className={styles.itemLeft}>
                    ...
                    <div>
                      ...
                      <div className={styles.itemDetail}>
                        {qty} {product.unit} × KES {product.price.toLocaleString()}
                      </div>
                    </div>
                  </div>
              ...
              <div className={styles.waNote}>
                Your order will open in WhatsApp as a ready-written message. Just tap Send and we will confirm delivery details with you.
              </div>

              <button className={styles.waBtn} onClick={onSendWA}>
